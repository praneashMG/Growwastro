...
<header id="mainNavbar"
  class="fixed top-0 left-0 w-full z-50 bg-white text-[#7F1D1D] shadow-[0_4px_12px_rgba(0,0,0,0.25)] transition-all duration-300">
      ...
      <ul class="flex items-center gap-10 font-medium text-sm" id="navLinks">
        ...
        <li class="relative">
          ...
          <ul id="homeDropdownMenu"
            ...
            <li>
              <a href="index.html"
                class="block px-4 py-2 rounded-t-xl transition hover:bg-[#f2de8c] text-[#7F1D1D]">
                Home 1
              </a>
            </li>
            ...
            <li>
              <a href="home2.html"
                class="block px-4 py-2 rounded-b-xl transition hover:bg-[#f2de8c] text-[#7F1D1D]">
                Home 2
              </a>
            </li>
        ...
        <li class="relative">
          ...
          <ul id="dashboardDropdownMenu"
            ...
            <li>
              <a href="user.html"
                class="block px-4 py-2 hover:bg-[#f2de8c] text-[#7F1D1D] rounded-t-xl transition">
                User
              </a>
            </li>
            ...
            <li>
              <a href="admin.html"
                class="block px-4 py-2 hover:bg-[#f2de8c] text-[#7F1D1D] rounded-b-xl transition">
                Admin
              </a>
            </li>
...
<!-- Mobile Menu -->
<div id="mobileMenu"
  class="fixed top-0 right-0 h-full w-72 bg-[#f6e9b4] text-[#7F1D1D] z-50
         transform translate-x-full transition-transform duration-300 lg:hidden shadow-2xl">

  <!-- Header -->
  <div class="flex items-center justify-between p-5 border-b border-[#7F1D1D]">
    <h2 class="text-xl font-bold">Menu</h2>
    <button id="closeMenuBtn" class="text-3xl transition">
  ...
  <div class="p-6 overflow-y-auto h-full">
    <ul class="space-y-4">
      ...
      <!-- Mobile Extras -->
      <li class="pt-6 border-t border-[#7F1D1D] flex justify-around">
